<?php
include('dbconn.php');
$query = 'SELECT `ecsensor`, `time` AS `datetime` FROM `data` ORDER BY TIME DESC limit 100';
...
$table['cols'] = array( 
    ...
    array('label' => 'EC Sensor', 'type' => 'number')
);
...
while($row = mysqli_fetch_array($result))
{
 ...
 $sub_array[] =  array("v" => $row["ecsensor"]);
...
<head>
    ...
    var chart = new google.visualization.LineChart(document.getElementById('ecsensor_chart'));
